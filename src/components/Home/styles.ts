...
export const StyledHomeHero = styled.div<StyledHomeProps>`
  display: flex;
  align-items: center;
  min-height: 420px;
...
export const StyledGraphic = styled.svg<StyledHomeProps>`
  position: absolute;
  left: 50%;
  top: 50%;
  ...
  ${props => css`
    ...
    .graphic-1 {
      transform: ${props.collapse
        ? 'translate(0%, 0%) scale(1)'
        : 'translate(0%, 40%) scale(0)'};
